    ...
    Rectangle {
        ...
        Row {
            ...
            Icon {
                ...
                color: keyboardControl.active ? Style.white : Controllers.gamepad.gamepadConnected ? Style.green : Style.red;
            }
        ...
        Row {
            ...
            UiLabel {
                ...
                anchors.verticalCenter: parent.verticalCenter;
                text: Controllers.gamepad.allAxes[GamepadAxes.AxisX];
            ...
            UiLabel {
                ...
                font.family: Style.fontMono;
                anchors.verticalCenter: parent.verticalCenter;
                text: Controllers.gamepad.allAxes[GamepadAxes.AxisY];
                horizontalAlignment: Text.AlignRight;
                font.pointSize: 10;
            }
            ...
            UiLabel {
                ...
                font.family: Style.fontMono;
                anchors.verticalCenter: parent.verticalCenter;
                text: Controllers.gamepad.allAxes[GamepadAxes.AxisZ];
                horizontalAlignment: Text.AlignRight;
                font.pointSize: 10;
            }
        }
